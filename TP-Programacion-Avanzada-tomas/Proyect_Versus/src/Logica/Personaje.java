...
public class Personaje {
    ...
    public Personaje(String nombre, String tipo, String habilidadInicial) {
        ...
        this.con = new Conexion(); // Inicializa con
        con.conectar(); // Establece la conexión
    }
    ...
    private List<Habilidad> cargarHabilidadesDesdeBD(String nombrePersonaje) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al obtener habilidades: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
        return habilidades;
    }
}
